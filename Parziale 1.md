...
- **802.3 CSMA/CD (Ethernet):** I nodi ascoltano il canale (Carrier Sense). Mezzo condiviso (Multiple Access). Se due trasmettono insieme (Collision Detection), si attende un tempo casuale e si ritenta.
