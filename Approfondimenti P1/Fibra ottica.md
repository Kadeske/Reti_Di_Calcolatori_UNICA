...
2. **Splicing (Giunzione) meccanico:** Le due estremità vengono tagliate di netto, allineate in un tubetto e incollate con un gel speciale usando una macchinetta apposita. Discreta precisione, perdita del *10% della luce*.
    
3. **Fusione ottica:** È il metodo migliore. Un macchinario speciale fonde letteralmente a caldo il vetro delle due estremità, unendole a livello molecolare. La perdita di luce è quasi zero (*5-10%*).
